...
#
# HOW TO USE:
# 1. Copy the SVG from homeassistant/www/heat_pump_diagram.svg to /config/www/
# 2. Edit your dashboard
# 3. Add Card > Manual Card
# 4. Copy everything below the dashed line and paste it
# =============================================================================
# ---- COPY FROM HERE ----
...
elements:
  ...
  # ===== TAP ACTIONS FOR MORE INFO =====
  # Tap on outdoor unit for heat pump details
  - type: icon
